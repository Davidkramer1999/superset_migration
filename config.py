...
AUTH_LDAP_SERVER = "you ldap"

AUTH_LDAP_USE_TLS = False
AUTH_LDAP_SEARCH = "dc=ec,dc=si"

AUTH_LDAP_BIND_USER = "ldap"
AUTH_LDAP_BIND_PASSWORD = "secret"
AUTH_LDAP_ALLOW_SELF_SIGNED = True
AUTH_LDAP_UID_FIELD='secret'
AUTH_LDAP_APPEND_DOMAIN="secret"
...
def DB_CONNECTION_MUTATOR(uri, params, username, security_manager, source):
   # Ensure the user is logged in
    if username:
        ...
        uri.set('username', user.username)
        uri.set('password', user.password)
